<script type="text/javascript">
     ...
     $(document).ready(function()
     {
	  ...
	  // http://api.jquery.com/category/ajax/shorthand-methods/
                ...
                $("#nick").blur(function(){
                    $.post("chequearnick.php", { nick: $("#nick").val() }, //Petición ajax (1º parámetro página petición,                      campo a pasar)
                    function(respuesta)
                    {
	 ...
	 // });
	  ...
	  // Para probarlo meter algún nick en la tabla a modo de ejemplo.
        ...
        //      $.post("chequeanick.php", { nic: $(this).val() },
        //         function(resultados){
        //          color ="green";
        //          foco ="#password";
        //          if(resultados == "ERROR")
         ...
         //             foco="#nick";
                 ...
                 //    }
                  //else
                   // {
               //       $("#mensajes").clearQueue().fadeTo(0,0).html(resultados)
                //       .css("background-color",color).fadeTo(1000,1).fadeTo(1000,0); 
                //       $(foco).focus();
                   // }
       ...
       $("#nick").keyup(function(){ // Evento keyup
		  $.post("chequearnick.php", { nick: $("#nick").val() }, //Petición ajax (1º parámetro página petición,                      campo a pasar)
                 function(respuesta){
